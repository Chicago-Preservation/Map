...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // 2. Function to link a checkbox to a map layer
    function setupLayerToggle(checkboxId, layer) {
        // We must wait for the map to be fully initialized
        if (typeof map === 'undefined' || !map) {
            console.log("Map not ready, trying again in 100ms");
    ...
    // 3. Link all the Municipal Governance layers to their checkboxes
    // These variables (e.g., landmarksLayer) are created in map.html
